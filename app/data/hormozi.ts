...
export const HormoziHooks = [
  ...
  "What I wish I knew at [X] instead of [Y].",
  "Why do [X]% of [Y] do [Z]?",
  "If you don't like [X], but still want [Y], then do [Z].",
  "I've started hanging out with [X] group",
  "I said it before, I'm going to say it again...",
  "A lot of people don't know this...",
  "Look, I don't throw around the word genius often",
  "[X] has a problem",
  "Here is something about [X GROUP] that 99% of people don't know",
  "When the [X PERSON] in the company did [Y] know one knew why...",
  "The Number 1 mistake new [X] make...",
  "This is the ultimate guide for [X] on [Y].",
  "[GROUP] do not understand [X]",
  "If you're [X] need to do [X], remember [Y]",
  "Never [ACTION] Do This Instead",
  "I Tested [NUMBER] Years Of [SUBJECT]",
  "I Tried Every [SUBJECT]",
  "[NUMBER] Things I Wish I Knew [SUBJECT]",
  "If You're [CONDITION], Reach This",
  "I Asked 100 [SUBJECT] [QUESTION]",
